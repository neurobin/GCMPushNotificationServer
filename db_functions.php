...
class DB_Functions_GCM {
    ...
    function __construct() {
        ...
        $GLOBALS['mysqli_connection']= mysqli_connect(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE) or die("Error " . mysqli_error($GLOBALS['mysqli_connection']));
...
if($dbname!="" && $dbname!=null){
	$GLOBALS['mysqli_connection']= mysqli_connect($host,$user,$password,$dbname) or die("Error " . mysqli_error($GLOBALS['mysqli_connection']));}

else {$GLOBALS['mysqli_connection']= mysqli_connect($host,$user,$password) or die("Error " . mysqli_error($GLOBALS['mysqli_connection']));}
...
if ($result) {return true;} else {return false;}
    ...
    public function storeUser($name, $email, $gcm_regid) {
        ...
        if ($result) {
            // get user details
            $id = mysqli_insert_id($GLOBALS['mysqli_connection']); // last inserted id
